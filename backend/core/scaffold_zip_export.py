...
1. Open `{safe_name}.xcodeproj` in Xcode (16.0+)
   - If `.xcodeproj` is missing, install [XcodeGen](https://github.com/yonaskolb/XcodeGen) and run:
     ...
     xcodegen generate
     ```
2. Wait for Xcode to resolve SPM dependencies (EdgeKit and the binary EdgeHalo package are fetched automatically)
...
> EdgeKit, the binary EdgeHalo package, and their dependencies are resolved automatically
